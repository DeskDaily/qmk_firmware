...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
        ...
        KC_MYCM, KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,           KC_PGDN,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [0] =  { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_BRID, KC_BRIU),  ENCODER_CCW_CW(RGB_RMOD, RGB_MOD)  },
...
bool oled_task_user(void) {
    ...
    oled_write_P(led_state.num_lock ? PSTR("Num Lock On") : PSTR("Num Lock Off"), false);
    oled_write_P(led_state.caps_lock ? PSTR("Caps Lock On") : PSTR("Caps Lock Off"), false);
    oled_write_P(led_state.scroll_lock ? PSTR("Screen Lock On") : PSTR("Screen Lock Off"), false);
